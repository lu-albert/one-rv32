...
set_property PACKAGE_PIN V17 [get_ports {ra3[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {ra3[0]}]
set_property PACKAGE_PIN V16 [get_ports {ra3[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {ra3[1]}]
set_property PACKAGE_PIN W16 [get_ports {ra3[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {ra3[2]}]
set_property PACKAGE_PIN W17 [get_ports {ra3[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {ra3[3]}]
set_property PACKAGE_PIN W15 [get_ports {ra3[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {ra3[4]}]
set_property PACKAGE_PIN V15 [get_ports {sw_bit}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sw_bit}]
